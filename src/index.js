...
class RNTelySoftBluetooth extends NativeEventEmitter {
  constructor(nativeModule) {
    ...
    this.getDeviceName = nativeModule.getDeviceName;
    this.getDeviceMacAddress = nativeModule.getDeviceMacAddress;
    this.requestDiscoverable = nativeModule.requestDiscoverable;
   ...
   * the RNTelySoftBluetoothModule needs to know that it should continue to send data.
   */
  applyReadListeners = () => {
  ...
  write = (data) => {
    ...
    return this._nativeModule.writeToDevice(data.toString('base64'));
  }
}

export const BTEvents = NativeModules.RNTelySoftBluetooth.BTEvents;
export const BTCharsets = NativeModules.RNTelySoftBluetooth.BTCharsets;
export default new RNTelySoftBluetooth(NativeModules.RNTelySoftBluetooth);
