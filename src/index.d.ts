declare module '@telysoft/react-native-bluetooth' {
  ...
  namespace RNTelySoftBluetooth {
    ...
    function getDeviceMacAddress(): Promise<String>;

    function accept(): Promise<any>;
    function cancelAccept(): Promise<any>;

    function requestDiscoverable(): Promise<boolean>;
  ...
  export default RNTelySoftBluetooth;
}
