 ...
 *
 */
public class RNTelySoftBluetoothService {

    private static final String TAG = "RNTelySoftBluetoothService";
    private static final boolean D = BuildConfig.DEBUG;

    /**
     * Serial Port Protocol UUID
     */
    private static final UUID UUID_SPP = UUID.fromString("11102223-1234-5678-9000-00805F9B34FB");
     ...
     */
    private BTEventListener listener;
    ...
    /**
     * Constructor. Prepares a new RNTelySoftBluetoothService session.
     *
     * @param listener data received listener
     */
    RNTelySoftBluetoothService(BTEventListener listener) {
    ...
    /**
     * Puts the {@link RNTelySoftBluetoothService} into accept connection mode - allowing other
    ...
    synchronized void accept() {
        if (mAcceptThread != null) {
            if (D) Log.d(TAG, "RNTelySoftBluetoothServer is already in accept mode, continuing");
        } else {
    ...
    synchronized void cancelAccept() {
        if (mAcceptThread == null) {
            throw new IllegalStateException("RNTelySoftBluetoothService is not in accept mode");
        }
     ...
     *
     * TODO update so that service only deals with BTDevice instead
     *
    ...
    synchronized void stop() {
        if (D) Log.d(TAG, "Stopping RNTelySoftBluetooth service");
    ...
    private void connectionFailed(BluetoothDevice device, Throwable e) {
        ...
        RNTelySoftBluetoothService.this.stop(); // Start the service over to restart listening mode
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                synchronized (RNTelySoftBluetoothService.this) {
                    mConnectThread = null;
                }
            }
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                ...
                tmp = mAdapter.listenUsingRfcommWithServiceRecord("RNTelySoftBluetooth", UUID_SPP);
            } catch (IOException e) {
